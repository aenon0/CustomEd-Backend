...
namespace CustomEd.Announcement.Service.Consumers
{
    public class ClassroomCreatedEventConsumer : IConsumer<ClassroomCreatedEvent>
    {
        ...
        public ClassroomCreatedEventConsumer(IMapper mapper, IGenericRepository<ClassRoom> classRoomRepository, IGenericRepository<Teacher> teacherRepository)
        {
            _mapper = mapper;
        ...
        public async Task Consume(ConsumeContext<ClassroomCreatedEvent> context)
        {
            ...
            await _teacherRepository.CreateAsync(new Teacher { Id = classroom.CreatorId});
